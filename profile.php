                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="id_proof_type" class="form-select" required>
                                            ...
                                            <option value="Aadhar"  <?= $user['data']['id_proof_type'] == 'Aadhar' ? 'selected':''; ?> >Tax Paper</option>
                                            <option value="PAN"  <?= $user['data']['id_proof_type'] == 'PAN' ? 'selected':''; ?> >Government issued paper</option>
                                            <option value="Voter"  <?= $user['data']['id_proof_type'] == 'Voter' ? 'selected':''; ?> >Bank Proof</option>
                                        </select>
                                    </div>
                                </div>
