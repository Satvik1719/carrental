                ...
                <div class="col-md-4">
                    <div class="car-card sticky2">
                        ...
                        ?>
                            ...
                            <h5 class="title1 fs-16 mb-1">Per Hour <span class="float-end">CAD <?=$car['price_per_hour'];?>/hr</span></h5>
                            <h5 class="title1 fs-16 mb-1">Convenience Fee <span class="float-end">CAD 99</span></h5>
                            <?php 
                            ...
                            <hr class="my-3">
                            <h5 class="title1 mb-1">Total Price <span class="float-end"> CAD<?= ($difference * $car['price_per_hour']) + $convenienceFee; ?></span></h5>
